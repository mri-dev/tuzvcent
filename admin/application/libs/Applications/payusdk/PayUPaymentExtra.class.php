...
{
    public $targetUrl = "https://secure.payu.hu/order/idn.php";
    ...
    public function requestIdn($data = array())
    {
        ...
        $this->logFunc("IDN", $response, $response['ORDER_REF']);
    }                                      
...
{
    public $targetUrl = "https://secure.payu.hu/order/irn.php";
    public $missing = array();
    public $hashFields = array(
        "MERCHANT",
        "ORDER_REF",
    ...
    public function requestIrn($data = array())
    {
        ...
        $this->logFunc("IRN", $response, $response['ORDER_REF']);
    }         
