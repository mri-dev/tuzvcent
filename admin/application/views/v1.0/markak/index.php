	...
	<div class="col-md-12">
    	<div class="con edit">
            ...
            <input type="hidden" name="markaID" value="<?=$this->marka[ID]?>">
              ...
              <div class="row">
	            	<div class="col-md-2">
                	<label for="enb">Beszerzési árképzés</label>
              ...
              <br />
                <div class="row">
                 	<div class="col-md-2">
	                	<label for="nagyker_id">Raktár</label>
            	...
            	<div class="row markarow">
                    ...
                    <div class="col-md-1">
                    	...
                    	<? if($d[arres_mod] == '0') :?>
                        	<?=$d[fix_arres]?>%
                        <? else: ?>
                        	<a href="javascript:void(0);" mkid="<?=$d[ID]?>">árrés sávok</a>
                        <? endif;?>
                    </div>
